...
const TodoList1 = ({todoListID, title, tasks, removeTask, filterTask, addNewTask, changeStatusTask, filteredTask, removeTodolist, changeTitleTaskFromApp, changeTitleTodoListFromApp}: TodolistPropsType) => {
